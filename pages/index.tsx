...
function HomeButton(props: { label: string, dest: string }) {
    return (
        <form action={props.dest}>
            <button className='bg-black text-white p-3 mt-10 mb-24 rounded-md'>
                {props.label}
            </button>
        </form>
...
export default function Home() {
    return (
        <MUPage>
            ...
            <div className='text-yellow-700 bg-yellow-300'>
                ...
                <div className='flex flex-wrap'>
                    <Quadrant bg="bg-yellow-400" title='Volunteer'>
                        <h3>Help us fundraise and support our events</h3>
                        <HomeButton label='Apply' dest='/volunteer' />
                    </Quadrant>
                    <MediaFlexDivider />
                    <Quadrant title='Teach'>
                        <h3>Spread your love for music</h3>
                        <HomeButton label='Apply' dest='/teach' />
                    </Quadrant>
                    <FlexDivider />
                    <Quadrant title='Register'>
                        <h3>Start your child's music journey</h3>
                        <HomeButton label='Register' dest='/register' />
                    </Quadrant>
                    <MediaFlexDivider />
                    <Quadrant bg='bg-yellow-400' title='Donate'>
                        <h3>Help us run Music Unbounded</h3>
                        <HomeButton label='Learn More' dest='/donate' />
                    </Quadrant>
                </div>
            </div>
        </MUPage>
